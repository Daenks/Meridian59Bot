...
set mownerjoin {
  "\001ACTION heralds the entrance of our Lord God, %nick, \"Welcome, My Lord!\"\001"
}

# This is a greet message with CHANNEL MESSAGE type. For REGULAR USERS! set this following-
# the instruction up there. You can set this as many as you wish.
set mregjoin {
  "Hello, %nick, and welcome to %channel! We are a group of volunteers maintaining, updating, and expanding Meridian 59, the World's first commercially 3d MMORPG. You can learn more about us at http://openmeridian.org! Please use the command: !help if you'd like more information now. If you have a question, please ask it, and someone will reply as soon as possible."
}
...
set utlaglg "\[<(^_^)< OpenMeridian.org >(^_^)>\]:"
...
bind join - * autogreet
putlog "*** ${utlaglg} Entertainment, Advanced Auto Greet. Loaded."

# End of - Entertainment, Advanced Auto-Greet. (ent_agreet.tcl)
